...
// Hitung total rows
$count_stmt = $db->prepare("SELECT COUNT(*) FROM transactions_success WHERE username = ?");
...
$stmt = $db->prepare("SELECT * FROM transactions_success WHERE username = ? ORDER BY inputdate DESC LIMIT ? OFFSET ?");
