...
// Hitung total rows
$count_stmt = $db->prepare("SELECT COUNT(*) FROM transactions_invalid WHERE username = ?");
...
$stmt = $db->prepare("SELECT * FROM transactions_invalid WHERE username = ? ORDER BY inputdate DESC LIMIT ? OFFSET ?");
