...
// Hitung total rows
$count_stmt = $db->prepare("SELECT COUNT(*) FROM transactions_wd WHERE username = ?");
...
$stmt = $db->prepare("SELECT * FROM transactions_wd WHERE username = ? ORDER BY inputdate DESC LIMIT ? OFFSET ?");
...
<body>
    ...
    <section class="transaction-history-section">
        <div class="container">
            ...
            <a href="transaction-verify" class="add-button">Transaction Verify</a>
