...
<header>
        ...
        <nav>
            <ul id="menu">
                ...
                <li><a href="about" class="menu-link active">About</a></li>
    ...
    <section class="about-section register-section">
        <div class="container">
            <h2>Tentang PilahSampah</h2>
            <p>PilahSampah adalah platform inovatif yang bertujuan untuk mengubah sampah menjadi sesuatu yang berharga. Kami percaya bahwa dengan pemanfaatan sampah yang tepat, kita dapat menjaga lingkungan dan menciptakan masa depan yang lebih baik untuk generasi mendatang.</p>
